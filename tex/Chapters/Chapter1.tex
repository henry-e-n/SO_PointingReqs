...
\begin{enumerate}
    \item Simulate pointing errors in maps: \begin{itemize}
        ...
        \item SMARTIES - Map-space simulation, should allow me to consider pointing errors in maps - less documentation. Might also be limited to static pointing offsets which could be accounted for in pointing models.
    \end{itemize}
    \item Maps to power spectra:\begin{itemize}
    ...
    \end{itemize}
    \item Analyze power spectra to put constraints on parameters:\begin{itemize}
        \item Different parameters might have different estimation pipelines.
...
\begin{enumerate}
    \item Figure out how to simulate maps + include pointing errors (jitter beams) into maps: \begin{itemize}
        ...
        \item If the path is SMARTIES - Who can I talk to about SMARTIES because I have not yet found much documentation. Using SMARTIES will require I have a better understanding of how exactly different sources of pointing errors impact maps
        \item {\bf What pointing errors am I concerned with? Beam pointing offsets $\rightarrow$ simple `beam smoothing'. Jitter beams and more complex situations?}
        ...
        \item {\bf How realistic should my maps be? Do I start simple and ignore things like point sources, atmosphere models, noise? Presumably different science cases rely on different things, so different maps needed, point-sourced filtered, delensed?}
    \end{itemize}
...
\begin{itemize}
    \item Elle Shaw F2F 2026 - T1a: LAT Calibration - Pointing Summary 
    \item Zach Atkins + F2F 2026 - W1a: LAT Science Readiness - Power-spectrum pipelines
    \item Cristian Vargas F2F 2026 - W1a: LAT Science Readiness - Beam Jitter
    \item Magdy Morshed F2F 2026 - W2b: Simulations - SMARTIES
    \item Elisa Russier F2F 2026 - W2b: Simulations - Beam Systematics Requirements
\end{itemize}
\pagebreak
